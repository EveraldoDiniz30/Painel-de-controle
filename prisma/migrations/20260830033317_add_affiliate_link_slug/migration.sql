/*
  ...
  - Added the required column `slug` to the `AffiliateLink` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_AffiliateLink" ("campaignId", "createdAt", "date", "groupId", "id", "platform", "productId", "source", "status", "url") SELECT "campaignId", "createdAt", "date", "groupId", "id", "platform", "productId", "source", "status", "url" FROM "AffiliateLink";
